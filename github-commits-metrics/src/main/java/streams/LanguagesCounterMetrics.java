...
/**
 * Counts how many commits were done for curtain programming language.
 * Produces string value with the number of commits in the corresponding language, e.g. "Java: 500".
 */
public class LanguagesCounterMetrics extends MetricsStream {

  private static final String DEDUPLICATE_COMMITS_STORE = "languages-counter";

  public LanguagesCounterMetrics(Properties properties, String inputTopic, String outputTopic) {
    super(properties, inputTopic, outputTopic);
    this.properties.put(StreamsConfig.APPLICATION_ID_CONFIG, "commits-metrics-languages-counter");
  }
  ...
  protected Topology createTopology() {
    ...
    KTable<String, String> totalCommitsNumber = streamsBuilder
        ...
        .mapValues(CommitHelper::getLanguageOfCommit)
