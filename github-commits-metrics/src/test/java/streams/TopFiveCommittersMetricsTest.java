...
class TopFiveCommittersMetricsTest {
  ...
  void setUp() {
    ...
    MetricsStream metricsStream = new TopFiveCommittersMetrics(properties, INPUT_TOPIC, OUTPUT_TOPIC);
  ...
  void top5IsCounted() throws JsonProcessingException {
    ...
    Commit commit3 = new Commit()
        ...
        .setLanguage("java")
        .setMessage("message3")
        .setRepository("repository3")
        .setSha("sha3")
        .setDateTime(LocalDateTime.now());
    String commit3Json = mapper.writeValueAsString(commit3);
    ...
    assertEquals("top5_committers: author1 (1)", outputTopic.readValue());
    assertEquals("top5_committers: author1 (2)", outputTopic.readValue());
    assertEquals("top5_committers: author1 (2), author2 (1)", outputTopic.readValue());
  ...
  void checkDeduplicateCommitsCounter() throws JsonProcessingException {
    ...
    assertEquals("top5_committers: author (1)", outputTopic.readValue());
    assertTrue(outputTopic.isEmpty());
  }
  ...
  void closeKafkaStream() {
    MetricsStream metrics =
        new TopFiveCommittersMetrics(new Properties(), INPUT_TOPIC, OUTPUT_TOPIC);
